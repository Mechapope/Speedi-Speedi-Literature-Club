...
label ch1_y_end:
    ...
    mc "Even though the route is short, your notes are really descriptive."
    y 2t "It wasn't too short?"
    y "I usually run longer categories..."
    mc "Not at all."
    ...
    mc "Are you into ghosts, Noobest?"
    y 1m "Huhu."
    ...
    y 2l "Lingering in his last remaining place of comfort, unable to let go of the past."
...
label ch1_n_end:
    ...
    mc "Yeah...guess not."
    "I decide to humor his with that last comment."
    "I don't really care how old everyone is, but if Captaine is feeling proud then I won't take his records away from him."
    return
...
label ch1_s_end:
    ...
    s "It was a good poem. But it's over now."
    s "Miltent's a little bitch!"
    mc "Ah...yeah."
...
label ch1_s_good:
    ...
    mc "Jeez..."
    if y_readpoem:
        "Noobest's opinion was way more constructive than this..."
    else:
        "I'm sure Noobest's opinion has to be a little more constructive than this."
    if not n_readpoem:
        "Maybe even Capitaine's."
...
label ch1_y_bad:
    ...
    label ch1_y_shared:
        ...
        "Once Noobest finds his train of thought, it's as if his demeanor totally changes."
        ...
        y 1l "Capitaine can be a little bit biased, though..."
        mc "Biased? How?"
        y 2j "U-Um..."
        y "Well..."
        y "Never mind..."
        ...
        y "Sorry..."
        mc "It's fine."
        "I'm not sure if Noobest is apologizing to herself, to me, or to Capitaine."
        mc "Do you mind if I read your poem now?"
        y 3c "Please do!"
        y "I'd love to share my thought process behind it..."
        "Noobest smiles dreamily, as if that's a rare opportunity for her."
        "Which itself is kind of funny..."
        "...After all, isn't this supposed to be a speedrunning club?"
        return
...
label ch1_y_good:
    y 1e "..."
    "As Noobest reads the poem, I notice his eyes lighten."
    y 2f "...Exceptional."
    mc "Eh? What was that?"
    y "...?"
    y 2n "D-Did I say that out loud...?"
    "Noobest first covers his mouth, but then ends up covering his whole face."
    y 4c "I...!"
    y "Uu..."
    y "{i}(He's going to hate me...){/i}"
    mc "Um..."
    mc "You really didn't do anything wrong, Noobest..."
    y 4a "Eh...?"
    y "That's..."
    ...
    y 1e "Huh...?"
    "Noobest stares at me blankly, then looks at my poem again."
    y "..."
    y 2h "...Well, I know that!"
    y "I just meant...u-um..."
    "Noobest trails off, unable to find an excuse."
...
label ch1_m_start:
    ...
    m "If you ever have any suggestions for the club, like an easier to navigate website, or things we can do better..."
...
label m_natsuki_1:
    ...
    mc "Oh jeez..."
    m 1b "No, no!"
    m "It kind of makes me think of something Captaine would write."
    m "And he's a good writer, too."
    ...
    mc "I see..."
    mc "So you're saying that Capitaine is kind of like that?"
    m 2a "Sort of."
...
label m_sayori_1:
    ...
    m "It makes me think of something Santzo would like."
    mc "Is that so?"
    m 2d "You and Santzo are really good friends, right?"
    m "I wouldn't be surprised if you had those sorts of things in common."
    mc "Ah, well..."
    mc "We may be good friends, but Santzo and I are actually really different."
    m "Hmm..."
    m "Well, that may be the case."
    m 3a "But maybe there are also some similarities that you wouldn't expect."
    m "The way he talks about you..."
    ...
    m "Oh gosh, I sound like Noobest..."
    m 2a "...But in any case, Santzo's writing has kind of a gentle feel to it."
    m "I can tell that he likes exploring with emotions, like happiness and sadness."
...
label m_yuri_1:
    ...
    m 2a "You know that Noobest likes this kind of writing, right?"
    m "Writing that's full of imagery and symbolism."
    m 2d "Unlike Santzo, who likes using simple and direct words to describe happiness and sadness..."
    m "Noobest likes it when readers are left to derive their own meaning out of it."
    ...
    m "It can take years of practice, which I'm assuming Noobest has at this point."
